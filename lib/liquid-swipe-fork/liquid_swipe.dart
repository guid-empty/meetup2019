...
import 'package:raw_graphics/liquid-swipe-fork/page.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Page(
            pageView: slideDirection == SlideDirection.leftToRight ? pages[activePageIndex] : pages[nextPageIndex],
            percentVisible: 1.0,
          ),
          //Pages
          PageReveal(
            ...
            child: Page(
                pageView: slideDirection == SlideDirection.leftToRight ? pages[nextPageIndex] : pages[activePageIndex],
